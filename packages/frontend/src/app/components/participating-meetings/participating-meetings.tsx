...
export default function ParticipatingMeetings({ userId }: ParticipatingMeetingsProps) {
    const { data: meetings, error, isLoading } = trpc.useQuery(['getParticipatingMeetings', { userId }]);
