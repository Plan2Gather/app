...
const MultiDatePicker = forwardRef<unknown, MultiDatePickerProps>(
  ({ formData, setFormData, onSuccessfulSubmit }, ref) => {
    ...
    return (
      <FormControl error={error} required>
        ...
        <FormHelperText>
          Select dates that would work for the gathering. Shift click for a
          range.
        </FormHelperText>
      </FormControl>
    );
