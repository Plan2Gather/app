...
export default function Team() {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: 'I love problem solving and creating new things whether that be writing code or cooking. Depending on location when I am not working i am either backcountry skiing or surfing!',
    },
  ];
